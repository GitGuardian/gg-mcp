# Cursor IDE Rule: Secret Detection and Prevention
...
2. **Detect Existing Secrets:**
			- Use ggshield to scan the project directory and commit history for hardcoded secrets

## Commands for Execution
- **Scan Uncommitted Secrets:**
		- Command: `ggshield secret scan path .`
		- Purpose: Detect secrets in the current working directory or staged changes

- **Scan Commit History:**
		- Command: `ggshield secret scan repo .`
		- Purpose: Identify secrets embedded in the commit history of the repository
...
By implementing this rule, Cursor IDE aims to maintain a secure development environment by proactively managing the risk of hardcoded secrets in codebases.
